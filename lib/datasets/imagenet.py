        ...
        if self.test_mode:
            ...
            if ext.lower() in ('.pth', '.pt'):
                ...
                try:
                    ...
                    # Print a helpful message with the problematic file path
                    print(f"!!! Corrupted file detected (EOFError): {data_path}")
                    # Re-raise the exception to stop the data loader and alert the user
                    raise
                # --- MODIFICATION END ---
                ...
                # Added a try-except block here as well for robustness
                try:
                    ...
                    print(f"!!! Failed to load image file {data_path}: {e}")
                    raise
            else:
